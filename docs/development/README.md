...
Cómo se trabaja en este repositorio. Todo lo que alguien necesita para ser productivo el primer día.
...
**Aquí no van:** las razones de una elección técnica (`architecture/decisions/`) ni el despliegue a producción (`operations/`).
